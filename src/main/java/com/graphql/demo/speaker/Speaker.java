...
public final class Speaker {
	...
	public Speaker(Integer id, String name, String title, String company, Gender gender, String country, String email,
			String phoneNumber, String twitter) {
		this.id = id;
		this.name = name;
		this.title = title;
