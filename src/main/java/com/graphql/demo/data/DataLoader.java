...
import com.graphql.demo.event.Event;
import com.graphql.demo.event.EventRepository;
import com.graphql.demo.session.Level;
import com.graphql.demo.session.Session;
import com.graphql.demo.session.SessionRepository;
import com.graphql.demo.session.Tag;
import com.graphql.demo.session.TagRepository;
import com.graphql.demo.speaker.Gender;
import com.graphql.demo.speaker.Speaker;
import com.graphql.demo.speaker.SpeakerRepository;
...
public class DataLoader implements CommandLineRunner {
    ...
    public DataLoader(EventRepository eventRepository, SpeakerRepository speakerRepository, 
    ...
    public void run(String... args) throws Exception {
        ...
        if(eventRepository.count() == 0) {
            ...
            var event = new Event(1,
                    ...
                    + "This year, we are excited to have the developer-focused SpringOne event unite with the incredible VMware Explore 2023 in Las Vegas. "
                    + "Learn how Spring can take you from code to production at speed with its support for modern application architectures that run seamlessly on any cloud.",
